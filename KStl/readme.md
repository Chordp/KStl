---
title: 如何在内核优雅使用STL
date: 2020-10-22 20:03:51
tags: 内核 kernel STL C/C++
---
#### 内核使用STL
> STL天下第一!!!!
> 在内核使用stl只需要重载异常 new 等c艹函数就完事了



配置好的项目 [Github](https://github.com/Chordp/KStl)
效果
![图 1](https://chordp.coding.net/p/hexo/d/blog/git/raw/master/eb2aa7ee8f5a366873c854c181c1023d3a39dcdddbb597610e6b38057e76fd74.png)  

在内核使用STL只需要在vc++目录 > 包含目录 添加这个宏
```
$(VC_IncludePath);
```
并添加一个cpp 把下面代码复制进去即可,里面重载了new 异常等函数
